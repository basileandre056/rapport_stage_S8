...
% ------------------------------------------
% STYLE TITRES (version unifiée et cohérente)
% ------------------------------------------

% Chapitres numérotés — BLEU
\titleformat{\chapter}
...
% Sections — BLEU (et saut de page)
\titleformat{\section}
  {\Large\bfseries\color{ENIBblue}}
  {\thesection.\ }{0.5em}{}
\titlespacing*{\section}{0pt}{*4}{1em}

% Force les sections à commencer sur une nouvelle page
\usepackage{etoolbox}
...
% Chapitres non numérotés — BLEU (même style que les chapitres)
\newcommand{\BlueChapter}[1]{%
  \clearpage
  \phantomsection
  {\Huge\bfseries\color{ENIBblue}#1}%
...
\begin{minipage}[t][0.48\textheight][t]{\textwidth}
    ...
    \end{minipage} % ← ❗️ minipage interne correctement fermé
\end{minipage}    % ← ❗️ minipage externe
