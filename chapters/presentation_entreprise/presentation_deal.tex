...
Système d’Information sur la Nature et les Paysages (\gls{sinp}) régional, la gestion de la plateforme de données 
Borbonica, et intervient sur des thématiques transversales telles que les espèces exotiques envahissantes (\gls{eee}), 
la séquence \gls{erc} (Éviter – Réduire – Compenser) ou encore la diffusion des connaissances naturalistes.  
