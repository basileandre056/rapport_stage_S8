...
\begin{itemize}
    ...
    \item une forte dépendance aux partenaires (collectivités, \gls{ofb}, \gls{ifremer}, \gls{pnrun}, associations), rendant certaines actions vulnérables à des manques de coordination ou de moyens.
\end{itemize}
