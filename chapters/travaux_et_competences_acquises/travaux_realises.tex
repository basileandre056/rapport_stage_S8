...
automatiquement les résultats et de structurer les informations dans un format exploitable. Ce travail prépare une future 
extension de GeoNature vers de nouvelles sources d’acquisition de données naturalistes.
