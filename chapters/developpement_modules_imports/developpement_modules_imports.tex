...
La structuration des données repose sur le standard Darwin Core, tel que défini par le GBIF\footnote{\href{https://www.gbif.org/fr/darwin-core}{Présentation du format Darwin Core}}.
