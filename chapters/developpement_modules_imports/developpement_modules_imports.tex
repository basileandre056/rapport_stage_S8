...
\begin{figure}[H]
    \centering
    \includegraphics[width= 0.9\textwidth]{images/data_flow_schematics/extraction_programs_flow.png}
...
Le CSV brut généré par l’API est d’abord conservé à des fins de traçabilité,
...
\begin{figure}[H]
    \centering
    \includegraphics[width= 0.9\textwidth]{images/data_flow_schematics/extraction_data_flow.png}
...
Plus largement,
l’intérêt principal de ce schéma réside
dans la séparation volontaire
entre la phase d’extraction des programmes
et celle de l’extraction des données associées.
Ce découpage ne répond pas uniquement
à des considérations ergonomiques,
mais constitue un choix technique structurant du module.
...
Elle aboutit à une liste contrôlée,
exploitable par l’utilisateur,
qui sert de base à toutes les opérations ultérieures.

La phase d’extraction des données,
quant à elle,
s’appuie exclusivement sur cette liste.
Elle intervient dans un second temps,
une fois les programmes visualisés,
...
en pouvant exclure certains programmes
ou ajuster sa sélection
avant de lancer des traitements potentiellement longs.

Ainsi, ce schéma illustre une chaîne d’extraction
progressive et contrôlée,
dans laquelle la séparation
entre identification des programmes
et extraction des données
constitue un levier essentiel
de robustesse,
de cohérence
et de maîtrise des traitements.
...
\begin{figure}[H]
    \centering
    \includegraphics[width= 0.9\textwidth]{images/data_flow_schematics/plantnet_data_flow.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width= 0.9\textwidth]{images/data_flow_schematics/validation_taxref.png}
