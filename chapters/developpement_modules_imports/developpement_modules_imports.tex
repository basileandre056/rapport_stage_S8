...
Ces sources sont exposées via des services web, tels que des \gls{api} REST, des flux JSON structurés ou des services WFS. 
...
et impose un contrôle strict de la compatibilité des données avec le référentiel TAXREF.
...
En cas d’échec, le service TAXREF-LD du MNHN est sollicité. 
...
Ce cache permet d’éviter des requêtes répétées vers la base TAXREF locale ou les services TAXREF-LD pour un même nom scientifique, 
