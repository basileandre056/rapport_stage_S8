...
La Figure~\ref{fig:data-flow-program-extraction}
synthétise le mécanisme de filtrage géographique
...
La Figure~\ref{fig:data-flow-data-extraction}
illustre la séparation fonctionnelle
