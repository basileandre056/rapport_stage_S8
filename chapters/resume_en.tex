\noindent
As part of my engineering studies at \gls{enib}, I completed an assistant engineer
internship. Building on coursework in computer science, electronics, data processing,
and the \gls{crs} module, I was particularly interested in contributing my technical skills
to projects related to biodiversity and the marine environment.
\par\medskip

I carried out my internship on Réunion Island within \gls{deal} Réunion, and more
specifically in the Water and Biodiversity Service (\gls{seb}), Biodiversity Unit (\gls{ubio}).
...
pressure from invasive alien species (\gls{eee}) and land-use development, which makes
reliable and well-structured biodiversity data essential for environmental management.
\gls{deal} uses the \gls{geonature} application to centralise and manage such data, and my
internship consisted in developing an external module to automatically import data
from \gls{quadrige}, \gls{ifremer}’s database dedicated to marine and coastal environmental
monitoring.
\par\medskip
...
the \gls{crs} module. As I had not taken the \gls{cai} module, the internship also provided an
...
in naturalist data management and the administration of \gls{geonature}.
\par\medskip
