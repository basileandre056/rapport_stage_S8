...
À l’inverse, le système d’information \href{https://quadrige-app.ifremer.fr/}{\gls{quadrige}}, maintenu par l’Ifremer, rassemble un volume
...
Dans ce contexte, le projet a consisté à développer un \href{https://docs.geonature.fr/development.html\#developper-un-module-externe} {\textbf{module externe GeoNature}} capable
...
Le module interrogeait alors \href{https://quadrige-core.ifremer.fr/api/extraction/doc?doc=standard&lang=fr&name=result&type=standard}{l’API \gls{quadrige}}
pour récupérer les observations correspondantes \href{https://quadrige.ifremer.fr/support/Mes-donnees/J-extrais-mes-donnees/J-interroge-l-API-pour-extraire-mes-donnees/Je-regarde-des-videos-de-demo-sur-l-API}{Tutoriels vidéo}.
...
Les échanges avec Quadrige reposent sur l’API GraphQL récemment mise en place par l’Ifremer, 
...
Les autres réglages comprennent l’URL de l’API, le périmètre
