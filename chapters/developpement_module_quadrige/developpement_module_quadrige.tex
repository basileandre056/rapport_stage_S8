...
\subsection*{Quadrige}
\begin{itemize}
    \item Documentation API : \url{https://…}
    \item Portail d’assistance : \url{https://…}
    \item Tutoriels vidéo : \url{https://…}
    \item Accès à l’application : \url{https://…}
\end{itemize}

\subsection*{GeoNature}
\begin{itemize}
    \item Dépôt GitHub : \url{https://github.com/PnX-SI/GeoNature}
    \item Documentation générale : \url{https://docs.geonature.fr/}
    \item Guide de développement des modules externes : \url{https://docs.geonature.fr/development.html\#developper-un-module-externe}
\end{itemize}
