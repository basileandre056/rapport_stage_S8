...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.85\textwidth]{images/gant.png}
    \caption{Diagramme de Gantt détaillé présentant l’enchaînement des phases
        du stage, les périodes de développement et les jalons principaux}    \label{fig:Gantt}
\end{figure}
